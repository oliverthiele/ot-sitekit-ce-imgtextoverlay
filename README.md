# ot-sitekit-ce-imgtextoverlay

This TYPO3 extension provides a content element that displays an image with
text overlay. On small screen resolutions, the text is not displayed as
an overlay, but below the image. Buttons can be added as IRRE elements.
...
- Adds a content element for an image with text overlay
